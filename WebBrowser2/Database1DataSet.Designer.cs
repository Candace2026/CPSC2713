...
namespace WebBrowser2 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class BookmarksDataTable : global::System.Data.TypedTableBase<BookmarksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BookmarksRow AddBookmarksRow(int Id, string URL, string Title, System.DateTime Date) {
        ...
        public partial class BookmarksRow : global::System.Data.DataRow {
            ...
            public System.DateTime Date {
                get {
                    return ((global::System.DateTime)(this[this.tableBookmarks.DateColumn]));
                }
                set {
                    this[this.tableBookmarks.DateColumn] = value;
                }
            }
        }
...
namespace WebBrowser2.Database1DataSetTableAdapters {
    ...
    public partial class BookmarksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Bookmarks] WHERE (([Id] = @Original_Id) AND ([Title] = @Origin" +
                "al_Title) AND ([Date] = @Original_Date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Bookmarks] ([Id], [URL], [Title], [Date]) VALUES (@Id, @URL, @" +
                "Title, @Date);\r\nSELECT Id, URL, Title, Date FROM Bookmarks WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Bookmarks] SET [Id] = @Id, [URL] = @URL, [Title] = @Title, [Date] =" +
                " @Date WHERE (([Id] = @Original_Id) AND ([Title] = @Original_Title) AND ([Date] " +
                "= @Original_Date));\r\nSELECT Id, URL, Title, Date FROM Bookmarks WHERE (Id = @Id)" +
                "";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WebBrowser2.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, URL, Title, Date FROM dbo.Bookmarks";
        ...
        public virtual int Update(int Id, string URL, string Title, System.DateTime Date, int Original_Id, string Original_Title, System.DateTime Original_Date) {
        ...
        public virtual int Update(string URL, string Title, System.DateTime Date, int Original_Id, string Original_Title, System.DateTime Original_Date) {
            return this.Update(Original_Id, URL, Title, Date, Original_Id, Original_Title, Original_Date);
        }
    }
